...
def callback(call):
    ...
    if currency_code == 'else':
        bot.send_message(chat_id, "Введите 3-буквенный код валюты (напримерб JPY, GBP):")
    ...
    try:
        ...
        bot.send_message(chat_id, f'Результат: <b>{amount} USD = {result:.2f} {currency_code}</b>', parse_mode='HTML')
